...
mod tests {
    ...
    fn test_single_commit_invalid() {
        ...
        assert_eq!(
            ...
            \x20\x20  | \n\
            \x20\x20  = help: https://r.lintje.dev/r/SubjectCliche\n\
            \n\
            ...
            \x20\x20  | \n\
            \x20\x20  = help: https://r.lintje.dev/r/MessagePresence\n\
            \n\
    ...
    fn test_single_commit_invalid_with_color() {
        ...
        assert_eq!(
            ...
            \u{1b}[0m\u{1b}[38;5;12m    | \u{1b}[0m\n\
            \u{1b}[0m\u{1b}[38;5;12m    = \u{1b}[0mhelp: https://r.lintje.dev/r/SubjectCliche\n\
            \n\
            ...
            \u{1b}[0m\u{1b}[38;5;12m    | \u{1b}[0m\n\
            \u{1b}[0m\u{1b}[38;5;12m    = \u{1b}[0mhelp: https://r.lintje.dev/r/SubjectMood\n\
            \n\
            ...
            \u{1b}[0m\u{1b}[38;5;12m    | \u{1b}[0m\n\
            \u{1b}[0m\u{1b}[38;5;12m    = \u{1b}[0mhelp: https://r.lintje.dev/r/MessagePresence\n\
            \n\
